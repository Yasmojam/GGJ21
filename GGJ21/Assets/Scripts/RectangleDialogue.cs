...
public class RectangleDialogue : MonoBehaviour {
    ...
    private List<string> dialogue = new List<string> {
        ...
        "Rectangle: I can see some pine over there on the farthest islands...",
        ...
        "Rectangle: If you complete each puzzle you get a mattock! You can use the wood and stones you pick up to navigate between islands to collect the pine",
        "Rectangle: Rafts to get between sets of islands require 5 pine planks, bridges between islands require 2 planks and 2 stones. And the big boat needs 15 Pine planks and 10 stones",
